    ...
    <div className="plans">
      ...
      <div className="plan-list">
        <div className="plan-item">
          ...
          <button className="cta-button" onClick={() => handlePlanSelect('basic')}>Choose Basic</button>
        </div>
        <div className="plan-item">
          <div className="plan-header">
          ...
          <button className="cta-button" onClick={() => handlePlanSelect('standard')}>Choose Standard</button>
        </div>
        <div className="plan-item">
          <div className="plan-header">
          ...
          <button className="cta-button" onClick={() => handlePlanSelect('premium')}>Choose Premium</button>
        </div>
      </div>
    </div>
  );
