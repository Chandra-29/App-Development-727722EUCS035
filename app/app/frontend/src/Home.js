...
const Home = () => {
    ...
    <>
      ...
      <div className="home">
        <header className="home-header">
          <img 
            src="https://img.freepik.com/premium-photo/king-golden-chess-standing-falling-silver-chess-board-concepts-leadership_101448-1406.jpg" 
            alt="Chess Mastery" 
            className="home-image" 
          />
          <div className="header-content">
            <h1 className="welcome-text">Welcome to GrandMaster Chess Academy</h1>
        ...
        <section className="home-highlight">
          <h2>Why Choose GrandMaster Chess Academy?</h2>
          <div className="home-content">
            <p>At GrandMaster Chess Academy, we are committed to fostering chess talent through a unique blend of time-honored techniques and cutting-edge strategies. Our programs are tailored to cater to every skill level, ensuring each participant reaches their full potential.</p>
            <ul>
  ...
  <div className="success-stories">
    <div className="story">
      ...
      <p>"Joining GrandMaster Chess Academy was a game-changer for me. The personalized coaching and strategic insights helped me win my first regional tournament and set new personal records."</p>
  ...
  <div className="success-stories">
    <div className="story">
      ...
      <p>"GrandMaster Chess Academy has been instrumental in my chess journey. The coaches' expertise and the supportive community have helped me achieve my goals and continuously improve my game."</p>
      <p><strong>Achievements:</strong></p>
      <ul>
        <li>
          <i className="fas fa-chess-king" style={{ color: '#ffcc00' }} />
    ...
    <div className="story">
      ...
      <p>"The training programs at GrandMaster Chess Academy are exceptional. The combination of theory, practical workshops, and personalized feedback has been invaluable in my chess development."</p>
      <p><strong>Achievements:</strong></p>
      <ul>
        <li>
        ...
        <section className="home-contact">
          ...
          <div className="contact-info">
            <div className="contact-item">
              <h3>Email Us</h3>
              <p>Email: <a href="mailto:info@elitechessacademy.com">info@Cubechessacademy.com</a></p>
            </div>
            <div className="contact-item">
              <h3>Call Us</h3>
        ...
        <footer className="home-footer">
          <p>&copy; 2024 GrandMaster Chess Academy. All rights reserved.</p>
